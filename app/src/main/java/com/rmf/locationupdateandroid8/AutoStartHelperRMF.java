...
public class AutoStartHelperRMF {
    ...
    private AutoStartHelperRMF() {
    }

    public static AutoStartHelperRMF getInstance() {
        return new AutoStartHelperRMF();
    }
...
//                        PrefUtil.writeBoolean(context, PrefUtil.PREF_KEY_APP_AUTO_START, true);
    ...
    private void autoStartOppo(final Context context) {
        Log.e("auto_start_oppo","enter oppo");
